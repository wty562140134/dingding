package com.youtong.dingding.controller.IsvReceiv.auth;
...
import com.youtong.dingding.controller.IsvReceiv.IsvEnv.OApiException;
import com.youtong.dingding.controller.IsvReceiv.IsvEnv.OApiResultException;
...
public class AuthHelper {
	...
	public static String getAccessToken() throws OApiException {
		...
		if (currentTime - lastTime >= cacheTime) {
			String url = Env.OAPI_HOST + "/gettoken?" + "corpid=" + Env.CORP_ID
	...
	public static String getJsapiTicket(String accessToken)
		...
		if (jsapiTicket == null) {
			String url = Env.OAPI_HOST + "/get_jsapi_ticket?" + "type=jsapi"
	...
	public static String sign(String ticket, String nonceStr, long timeStamp,
	...
	public static String getConfig(String urlString, String queryString) {
		...
		return "{jsticket:'" + ticket + "',signature:'" + signature
